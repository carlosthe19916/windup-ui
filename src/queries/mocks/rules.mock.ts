...
if (
  ...
  const rule1: Rule = {
    ...
    definition: `<rule id="embedded-framework-libraries-02000" xmlns="http://windup.jboss.org/schema/jboss-ruleset">
    <when>
...
In the links below there are the instructions to enable alternative versions for both EAP 6 and 7.
  ...
  const rule2: Rule = {
    id: "environment-dependent-calls-02000",
    title: "Call of JNDI lookup",
    definition: `<rule id="environment-dependent-calls-02000" xmlns="http://windup.jboss.org/schema/jboss-ruleset">
  <when>
